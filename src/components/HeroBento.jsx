    ...
    <section className="w-full px-4 pt-24 pb-4 flex justify-center">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
          ...
          <div className="group relative md:col-span-3 md:row-span-2 rounded-2xl overflow-hidden bg-gradient-to-br from-violet-600 via-purple-700 to-indigo-900 p-7 flex flex-col justify-between min-h-[200px] transition-all duration-500 hover:-translate-y-1 hover:shadow-2xl hover:shadow-purple-500/40">
            {/* Decorative circles */}
            ...
            {/* Soft glow blob */}
            <div className="absolute top-1/3 left-1/2 w-56 h-56 -translate-x-1/2 rounded-full bg-purple-300 blur-3xl pointer-events-none animate-glow-pulse transition-transform duration-700 group-hover:scale-125" />
            {/* Dot grid ornament */}
            <div
            ...
            {/* Tag above title */}
            {tag && (
              <span className="relative z-10 inline-block text-xs font-semibold tracking-widest uppercase text-violet-200 bg-white/10 border border-white/20 rounded-full px-3 py-1 w-fit mb-3">
                {tag}
              </span>
            )}
            ...
            {/* Eyebrow */}
            {eyebrow && (
              <span className="relative z-10 block text-xs sm:text-sm font-medium uppercase tracking-widest text-violet-200/70 mb-1">
                {eyebrow}
              </span>
            )}
          ...
          <div className="group md:col-span-1 md:row-span-1 rounded-2xl overflow-hidden relative min-h-[100px] bg-gradient-to-br from-emerald-600 via-green-600 to-teal-800 flex items-center justify-center transition-all duration-500 hover:-translate-y-1 hover:shadow-2xl hover:shadow-emerald-500/50">
